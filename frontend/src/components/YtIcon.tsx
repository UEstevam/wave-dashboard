...
export default function YtIcon({ size = 16, className = '' }: Props) {
  return (
    <svg width={size} height={size * 0.7} viewBox="0 90 580 400" fill="currentColor" className={className} aria-hidden="true">
